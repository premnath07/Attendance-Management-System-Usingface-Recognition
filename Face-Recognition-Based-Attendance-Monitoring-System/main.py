...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'premnathbillava421@gmail.com' ")
...
trainImg = tk.Button(frame2, text="Save Profile", command=TrainImages, fg="white", bg="#6d00fc", width=34, height=1, activebackground="white", font=('comic', 15, ' bold '))
...
def send_email():
    ...
    from_email = "premnathbillava@gmail.com"  # Update with your email
    password = "ojzs kwks lsup shpb"  # Update with your email password
